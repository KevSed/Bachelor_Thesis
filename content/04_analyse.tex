...
\begin{table}[H]
  ...
  \begin{tabular}{ll@{$\,\pm$}S}
    \toprule
    \textbf{Crystall Ball 1}      &  \multicolumn{2}{c}{fit-Ergebnis} \\
    \midrule
    ...
    \quad$N$                      & 1       & 1 \\
    \midrule
    \textbf{Crystall Ball 2}      &  \multicolumn{2}{c}{fit-Ergebnis} \\
    \midrule
    ...
    \quad$N$                      & 1       & 1 \\
    \midrule
    \textbf{Exponentialfunktion}  &  \multicolumn{2}{c}{fit-Ergebnis} \\
    \midrule
    \quad$c$                      & -0,008   & 0,002 \\
    \midrule
    \quad$f$                      & 0,52     & 0,01 \\
...
\begin{table}[H]
  ...
  \begin{tabular}{ll@{$\,\pm$}S}
    \toprule
    \textbf{IPATIA}               &  \multicolumn{2}{c}{fit-Ergebnis} \\
    \midrule
    \quad$a$                      & 1,41    & 0,04 \\
    \quad$a_2$                    & 1,41    & 0,04 \\
    \quad$n$                      & 1,41    & 0,04 \\
